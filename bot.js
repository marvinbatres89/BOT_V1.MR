/* ==========================================
   BOT V1 MR
   BOT.JS
   FIX13.9 SIGNAL GATE + CUENTA SEGURA
...
import {
  signalBridge
} from "./signal-bridge.js?v=FIX13-9-SIGNAL-GATE";


import {
  botEngine
} from "./bot-engine.js?v=FIX13-9-SIGNAL-GATE";
...
registrarActividad(
  "FIX13.9 SIGNAL GATE + CUENTA SEGURA activa.",
  "correcto"
);
