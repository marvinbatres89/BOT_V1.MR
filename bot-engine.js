...
/* ==========================================
   FIX14.8 · FAVORABLE PRIORITY GATE
...
const HISTORICAL_OPPORTUNITY_CONTROL = {
  ...
  /* Confianza mínima actual para considerar rescate histórico. */
  minimumSignalConfidence: 72,

  /* Coincidencia de patrón cercana. */
  minimumSamples: 3,
...
class BotEngine {
  ...
  constructor() {
    ...
    this.modo =
      "DERIV DEMO + FIX14.8 FAVORABLE PRIORITY";
  ...
  /* ========================================
     FIX14.8 · PRIORIDAD FAVORABLE HISTÓRICA
     ======================================== */
 ...
 obtenerResumenTimingDireccion() {
  ...
  async procesarEjecucion(
    ...
    */
    ...
    /*
      FIX14.8 · PRIORIDAD FAVORABLE CONTROLADA
    ...
    if (
      ...
      this.emitirEvento(
        "bot:historical-rescue-activated",
        {
          ...
          analisisRegimenRacha,
          analisisOportunidadHistorica,
          motivo: "FIX14.8: evidencia histórica favorable prioritaria liberó únicamente EVIDENCIA_INSUFICIENTE."
        }
      );
