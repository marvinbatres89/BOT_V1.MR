/* ==========================================
   BOT V1 MR
   BOT-ENGINE.JS
   FIX14.2 PARITY MOVEMENT FILTER
...
class BotEngine {
  ...
  constructor() {
    ...
    this.modo =
      "DERIV DEMO + FIX14.2 PARITY MOVEMENT FILTER";
    ...
    */
    ...
    /*
      FIX14.2:
      memoria independiente del movimiento
      EVEN / ODD previo a la entrada.
    */
 ...
 obtenerResumenTimingDireccion() {
  ...
  iniciar() {
    ...
    return {
      ...
      mensaje:
        "Bot iniciado FIX14.2 PARITY MOVEMENT FILTER."
  ...
  async ejecutarCompraPreparada(
    ...
    */
    ...
    const movimientoParidadActualizado =
