/* ==========================================
   BOT V1 MR
   BOT-ENGINE.JS
   FIX14.9.1 SHARED ABSOLUTE CLOCK + FAVORABLE ZONE GATE + LOSS PROTECTION
...
const SYNC_VERSION =
  "SYNC-V3.8.2-SHARED-ABSOLUTE-CLOCK";
...
class BotEngine {
  ...
  /* ========================================
     ESPERA HASTA EPOCH ABSOLUTO
     SYNC V3.8.2
     ======================================== */

  async esperarHastaEpoch(
    targetEpoch
  ) {
