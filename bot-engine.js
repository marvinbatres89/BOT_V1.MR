/* ==========================================
   BOT V1 MR
   BOT-ENGINE.JS
   FIX14.6 HISTORICAL OPPORTUNITY GATE + LOSS PROTECTION
...
/* ==========================================
   FIX14.6 · HISTORICAL OPPORTUNITY GATE
   Busca antecedentes ganadores cercanos a la
   señal actual en la memoria ya acumulada.

   No anula filtros de RIESGO. Solo puede
   liberar una señal rechazada por evidencia
   insuficiente cuando hay historial positivo.
   ========================================== */
...
const HISTORICAL_OPPORTUNITY_CONTROL = {
  ...
  strongSamples: 8,
  maxConfidenceBucketDistance: 4,
  maxScoreBucketDistance: 10,
  maxValueBucketDistance: 10,
  minimumWeightedScore: 68,
  afterOneLossMinimumSamples: 5,
  afterOneLossMinimumAccuracy: 75,
  afterTwoLossesMinimumSamples: 8,
...
class BotEngine {
  ...
  constructor() {
    ...
    this.modo =
      "DERIV DEMO + FIX14.6 HISTORICAL OPPORTUNITY";
 ...
 obtenerResumenTimingDireccion() {
  ...
  iniciar() {
    ...
    return {
      ...
      mensaje:
        "Bot iniciado FIX14.6 HISTORICAL OPPORTUNITY GATE + LOSS PROTECTION."
